      ...
      <div className='flex flex-row w-full h-screen'>
        <aside className='hidden flex-col space-y-3 bg-blue-500 text-white p-4 w-1/4 md:pt-8 md:pl-4 md:flex'>
          ...
          <ul className="overflow-auto flex flex-col space-y-3">
            ...
            <li className='flex flex-col p-2 text-left font-bold cursor-pointer '>
              ...
              <div className={blogsActive ? '' : 'hidden'}>
                <ol className='ml-6 font-semibold flex flex-col space-y-2'>
                  ...
                  <li>
                    <Link to="/blogRequests">Publish request</Link>
                  </li>
                  <li>
                    <Link to="/blogs">Just blog</Link>
                  </li>
                </ol>
              </div>
            </li>
            ...
            {/* Mailing */}
            <li className='flex flex-col p-2 text-left font-bold cursor-pointer '>
              <div onClick={mailListener} className="flex flex-row items-center ">
                <svg className={mailActive ? 'w-8 h-8' : "w-5 h-5"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 9v.906a2.25 2.25 0 01-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 001.183 1.981l6.478 3.488m8.839 2.51l-4.66-2.51m0 0l-1.023-.55a2.25 2.25 0 00-2.134 0l-1.022.55m0 0l-4.661 2.51m16.5 1.615a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V8.844a2.25 2.25 0 011.183-1.98l7.5-4.04a2.25 2.25 0 012.134 0l7.5 4.04a2.25 2.25 0 011.183 1.98V19.5z" />
                </svg>
                Notify Via Mail
              </div>
              {/* blogs sub item */}
              <div className={mailActive ? '' : 'hidden'}>
                <ol className='ml-6 font-semibold flex flex-col space-y-2'>
                  <li>
                    <Link to="/previousMail">All Mails</Link>
                  </li>
                  <li>
                    <Link to="/notify-via-mail">Write a Mail</Link>
                  </li>
                </ol>
              </div>
            </li>
        ...
        <div className="content flex flex-col bg-blue-50 w-full h-[100%]">
          ...
          <header className=' bg-blue-300 m-3 p-6 rounded-lg py-6 flex flex-row justify-between items-center'>
            <div>
              <h3 className=' text-xl font-bold text-blue-950'>Computer and Programming Club</h3>
              <h3 className=' text-md font-semibold text-blue-950'>Pabna University of Science and Technology</h3>
            </div>
            <div className='flex flex-col'>
              <h5 className=' text-blue-950 font-semibold'>{user.name}</h5>
              <button onClick={onLogout} className=' px-2 my-1 rounded-sm bg-blue-200 text-red-700'>Logout</button>
            </div>
          </header>
